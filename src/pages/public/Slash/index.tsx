...
export const Slash: React.FC = () => {
  ...
  return (
    <div className="relative isolate bg-gray-900 py-24 sm:py-32 w-full" style={{ height: 'calc(100vh - 3.5rem)', maxHeight: 'calc(100vh - 3.5rem)', overflowX: 'hidden', overflowY:'auto', backgroundImage: 'url(/images/backgrounds/bg4.jpg)' }}>
      <img
        alt=""
        src="/images/backgrounds/bg4.jpg"
        className="absolute inset-0 -z-10 size-full object-cover object-right md:object-center hidden"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8 text-black-shadow" >
        ...
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.name} className="flex flex-col-reverse gap-1 text-black-shadow">
                <dt className="text-base/7 text-gray-300 text-black-shadow">{stat.name}</dt>
                <dd className="text-4xl font-semibold tracking-tight text-white text-black-shadow">{stat.value}</dd>
              </div>
            ))}
          </dl>
        </div>
